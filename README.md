...
Tracks declared dividends for 20 large UK-listed companies. Shows the announced timetable (declaration, ex-dividend and payment dates, plus amount) where a dividend has been declared, and an indicative next ex-date estimated from historical payment cadence where it hasn't.
...
- Company IR websites
- dividenddata.co.uk (UK dividend declarations / RNS)
- Market FX feeds
- Yahoo Finance
- MSCI datasets
